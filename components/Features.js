  ...
  return (
    <div>
      ...
      <section className='flex flex-col w-11/12 p-10 m-auto border-8 border-gray-400 rounded-lg md:grid-cols-2 md:grid'>
        <div className='mx-auto bg-blue-200 rounded-full'>
          <Image src='/images/features1.svg' width={500} height={300} />
        </div>
        <div className='flex flex-col items-center justify-center'>
          ...
          <span className='flex flex-col items-center'>
            <p className='w-full p-4 mb-1 ml-auto mr-auto text-xl text-white rounded-lg bg-sky-700'>
              ...
              fringilla. Nam mollis augue odio, eget scelerisque justo facilisis
              vel.
            </p>
        ...
        <div className='mx-auto mt-12 bg-blue-200 rounded-full'>
        ...
        <div className='mt-12 mr-2 bg-blue-200 rounded-full'>
