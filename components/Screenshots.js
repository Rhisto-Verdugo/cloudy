...
const Screenshots = () => {
  return (
    <Fade triggerOnce>
      <section className='pb-4 bg-blue-100'>
        <div className='flex flex-col-reverse items-center justify-center w-11/12 grid-cols-2 gap-4 pt-20 m-auto bg-gray-900 lg:grid rounded-3xl'>
